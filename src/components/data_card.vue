            ...
            <div class="logo">
                <div class="logo1">
                    <svg viewBox="0 0 29.667 31.69" xmlns="http://www.w3.org/2000/svg" id="logo-main">
                        ...
                        <path transform="translate(-45.91 0)"
                        ...
                        <path transform="translate(0 -51.963)"
                ...
                <div class="logo2">
                    <svg viewBox="0 0 101.014 23.535" xmlns="http://www.w3.org/2000/svg" id="logo-second">
                        <g transform="translate(-1029.734 -528.273)">
                            <path transform="translate(931.023 527.979)"
                            ...
                            <path transform="translate(888.72 528.773)"
                            ...
                            <path transform="translate(842.947 528.771)"
                            ...
                            <path transform="translate(814.555 528.773)"
                            ...
                            <path transform="translate(772.607 528.773)"
